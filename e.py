...
# e - access e numbers from terminal
#   e (executable)
#
#   github.com/ferhatgec/e
#
...
if len(argv) < 2:
    print(argv[0], '{e-number}')
    exit(1)

def get(additives_list):
    for index, arg in enumerate(argv):
        if index == 0:
            continue

        data = additives_list.get(arg.upper(), '')

        if data:
            print(f'\033[0;93m{arg}: \033[0m{data}')
